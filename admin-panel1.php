...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="BDMS/admin/dashboard.php" role="tab" aria-controls="home">Blood Donation</a>
               ...
               <div class="col-sm-4">
                ...
                <div class="col-sm-4" style="left: -3%; margin-top: 5%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                    <span class="fa-stack fa-2x"><i class="fa fa-square fa-stack-2x text-primary"></i><i class="fa fa-list-ul fa-stack-1x fa-inverse"></i></span>
                    <h4 class="StepTitle" style="margin-top: 5%;">Blood Donation</h4>
                     <p class="cl-effect-1"><a href="BDMS/admin/dashboard.php">View Blood Donation</a></p>
    </div>
  </div>
</div>
