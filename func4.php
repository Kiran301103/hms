...
if(isset($_POST['pharmsub1'])){
	$dname=$_POST['username4'];
	$dpass=$_POST['password4'];
	$query="select * from pharmacist where username='$dname' and password='$dpass';";
    ...
    while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
		...
		header("Location:pharm/index.php");
	}
	else{
