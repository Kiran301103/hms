...
<!--         <a href="newsell"><li><i class="fa fa-circle-o fa-fw"></i> New Sell</li></a> -->
        ...
        <a href="../pres.php"><li><i class="fa fa-circle-o fa-fw"></i> Patients Prescription</li></a>
      </ul><
    </div>
  </div>
  ...
  <div class="item">
      <ul class="nostyle zero">
       ...
       <a href="profile.php"><li><i class="fa fa-circle-o fa-fw"></i> Profile Setting</li></a>
        ...
        <a href="../index.php"><li><i class="fa fa-circle-o fa-fw"></i> Sign Out</li></a>
      </ul><
    </div>
</div>
...
<div class="account" style="display: none;">
  ...
  <div style="padding: 11px;">
    ...
    <a href="../index.php"><button class="btn btn-default pull-right" style="border-radius: 0">Sign Out</button></a>
  </div>
</div>
